    ...
    setState(() {
      ...
      if (index == 1) {
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    Sitting())); // استبدل  بالصفحة التي ترغب في الانتقال إليها
      }
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            icon: Icon(
              Icons.person,
              color: Color.fromARGB(255, 14, 71,
                  96), //elevation: _selectedIndex == 0 ? _iconElevation : 0
            ),
            label: '',
          ),
          BottomNavigationBarItem(
            icon: Icon(
              Icons.settings,
              color: Color.fromARGB(255, 14, 71,
                  96), //elevation: _selectedIndex == 0 ? _iconElevation : 1
            ),
            label: '',
          ),
          BottomNavigationBarItem(
            icon: Icon(
              Icons.home,
              color: Color.fromARGB(255, 14, 71,
                  96), // elevation: _selectedIndex == 0 ? _iconElevation : 2
            ),
            label: '',
          ),
          BottomNavigationBarItem(
            icon: Icon(
              Icons.favorite,
              color: Color.fromARGB(255, 14, 71,
                  96), //elevation: _selectedIndex == 0 ? _iconElevation : 3
            ),
            label: '',
          ),
          BottomNavigationBarItem(
          ...
          BottomNavigationBarItem(
            icon: Icon(
              Icons.add,
              color: Color.fromARGB(255, 14, 71,
                  96), // elevation: _selectedIndex == 0 ? _iconElevation : 4
            ),
            label: '',
          ),
        ],
